<footer>
    ...
    <div class="container py-4 text-white">
        ...
        <div class="row">
            <div class="mb-3 col-lg-3 col-md-6 col-sm-6 text-center">
                <img loading="lazy" src="{{ asset('img/logo-parquimica.webp') }}" width="200" height="auto" class="logo" alt="Parquimica Indústria" title="Parquimica Indústria">
                <br>
                ...
                <li class="nav-item">
                    ...
                    <img loading="lazy" src="{{ asset('img/icons/instagram.svg') }}" alt="Instagram" title="Instagram" width="32" height="32">
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link px-2" target="_blank" href="https://www.facebook.com/parquimicaindustrias/" title="Facebook">
                    <img loading="lazy" src="{{ asset('img/icons/facebook.svg') }}" alt="Facebook" title="Facebook" width="32" height="32">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-2" target="_blank" href="https://www.linkedin.com/company/parquimica" title="Linkedin">
                    <img loading="lazy" src="{{ asset('img/icons/linkedin.svg') }}" alt="Linkedin" title="Linkedin" width="32" height="32">
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link px-2" target="_blank" href="#" title="Youtube">
                    <img loading="lazy" src="{{ asset('img/icons/youtube.svg') }}" alt="Youtube" title="Youtube" width="32" height="32">
                    </a>
                </li>
  ...
  <div class="floating-button">
    <a href="https://wa.me/5591981199504/?text=Olá! Desejo obter mais informações sobre o catálogo de produtos!" class="float" title="Entre em contato pelo Whatsapp!">
      <img loading="lazy" src="{{ asset('img/icons/whatsapp.svg') }}" width="40" height="40" alt="icon-whatsapp" title="icon-whatsapp">
    </a>
  </div>
